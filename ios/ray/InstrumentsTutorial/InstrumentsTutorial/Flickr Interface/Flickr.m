...
+ (NSURL *)flickrPhotoURLForFlickrPhoto:(FlickrPhoto *)flickrPhoto size:(NSString *)size {
    ...
    return [NSURL URLWithString:[NSString stringWithFormat:@"http://farm%ld.staticflickr.com/%d/%lld_%@_%@.jpg", (long)flickrPhoto.farm, flickrPhoto.server, flickrPhoto.photoID, flickrPhoto.secret, size]];
}
